...
class Retro4 extends StatelessWidget {
  const Retro4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par de espelhos retrovisores kawasaki (NOVO)",
      "preco": "R\$ 95,00",
      "marca": "Kawasaki",
      "imagens": [
        "img/retro_kawa.jpg",
      ],
      "descricao": "Par de retrovisores de moto kawasaki.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Par de espelhos retrovisores kawasaki',
            style: TextStyle(
