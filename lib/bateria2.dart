...
class Bateria2 extends StatelessWidget {
  const Bateria2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Bateria de carro 72ah Start-Stop (NOVO)",
      "preco": "R\$ 800",
      "marca": "Moura",
      "imagens": [
        "img/bateria_moura_diferente.jpg",
      ],
      "descricao": "Bateria de chumbo-ácido de alta performance para veículos pesados, com capacidade de 72Ah e tensão de 12V.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Bateria de carro 72ah Start-Stop',
            style: TextStyle(
