...
class Radiador4 extends StatelessWidget {
  const Radiador4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Radiador de água Volkswagen (NOVO)",
      "preco": "R\$ 300",
      "marca": "Volkswagen",
      "imagens": [
        "img/radiador_vw.jpg",
      ],
      "descricao": "Radiador de água para veículos Volkswagen, como o Fox.",
    },
  ];
