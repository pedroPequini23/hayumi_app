...
class Escape4 extends StatelessWidget {
  const Escape4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Escapamento Silencioso Traseiro Palio 1.0 á 1.4 (NOVO)",
      "preco": "R\$ 132,19",
      "marca": "Fiat",
      "imagens": [
        "img/escape_palio.jpg",
      ],
      "descricao": "Escapamento Silencioso para o Fiat Pálio 1.0 a 1.4.",
    },
  ];
