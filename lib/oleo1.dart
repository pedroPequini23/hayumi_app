...
class Oleo1 extends StatelessWidget {
  const Oleo1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Óleo de Motor Lubrax 500ml (NOVO)",
      "preco": "R\$ 21,90",
      "marca": "Lubrax",
      "imagens": [
        "img/oleo1.jpg",
      ],
      "descricao": "Óleo de motor sintético para veículos, com proteção contra desgaste e corrosão.",
    },
  ];
