...
class Retro1 extends StatelessWidget {
  const Retro1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Retrovisor para Corolla elétrico (NOVO)",
      "preco": "R\$ 1020",
      "marca": "Toyota",
      "imagens": [
        "img/retro_corolla.jpg",
      ],
      "descricao": "Retrovisor elétrico com pisca compatível com Corolla 2020 2021 2022.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Retrovisor para Corolla elétrico',
            style: TextStyle(
