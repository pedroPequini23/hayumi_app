...
class Oleo3 extends StatelessWidget {
  const Oleo3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Óleo de Motor Ipiranga SI 1L (NOVO)",
      "preco": "R\$ 28",
      "marca": "Ipiranga",
      "imagens": [
        "img/oleo3.jpg",
      ],
      "descricao": "Óleo de motor sintético para veículos, com alta performance e proteção.",
    },
  ];
