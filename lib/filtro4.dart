...
class Filtro4 extends StatelessWidget {
  const Filtro4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Filtro de Ar Primário Donaldson (NOVO)",
      "preco": "R\$ 538,11",
      "marca": "Donaldson",
      "imagens": [
        "img/filtro4.jpg",
      ],
      "descricao": "Filtro de ar industrial de alta qualidade para aplicações pesadas.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Filtro de Ar Primário Donaldson',
            style: TextStyle(
