...
class Pneu5 extends StatelessWidget {
  const Pneu5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Pneus xbri aro 22 (NOVO)",
      "preco": "R\$ 8500",
      "marca": "Xbri",
      "imagens": [
        "img/pneu_aro22_xbri.jpg",
        "img/pneus_xbri_aro22.jpg",
      ],
      "descricao": "Pneus xbri aro 22 para caminhão.",
    },
  ];
