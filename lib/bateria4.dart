...
class Bateria4 extends StatelessWidget {
  const Bateria4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Bateria de carro Cral 60ah (NOVO)",
      "preco": "R\$ 360",
      "marca": "Cral",
      "imagens": [
        "img/bateria_cral.jpg",
      ],
      "descricao": "Bateria de carro Cral de 60ah",
    },
  ];
