...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Pneus 110H Scorpion (NOVO)",
      "preco": "R\$ 1800",
      "marca": "Pirelli",
      "imagens": [
        "img/pneu_110H_Scorpion.jpg",
        "img/pneus_scorpion_110h.jpg",
      ],
      "descricao": "4 pneus da marca pirelli 110h scorpion.",
    },
  ];
