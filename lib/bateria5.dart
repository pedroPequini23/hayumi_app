...
class Bateria5 extends StatelessWidget {
  const Bateria5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Bateria de carro Heliar Original 60ah (NOVO)",
      "preco": "R\$ 400",
      "marca": "Heliar",
      "imagens": [
        "img/bateria_heliar.jpg",
      ],
      "descricao": "Bateria de carro Heliar de 60ah",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Bateria de carro Heliar Original 60ah',
            style: TextStyle(
