...
class Retro5 extends StatelessWidget {
  const Retro5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par de retrovisor lateral motocicleta (NOVO)",
      "preco": "R\$ 120",
      "marca": "Independente",
      "imagens": [
        "img/retro_independente.jpg",
      ],
      "descricao": "Par de retrovisores laterais para motocicleta de marca universal.",
    },
  ];
