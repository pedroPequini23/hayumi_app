...
class Escape3 extends StatelessWidget {
  const Escape3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Escapamento silencioso para Gol G5 (NOVO)",
      "preco": "R\$ 194",
      "marca": "Volkswagen",
      "imagens": [
        "img/escape_golg5.jpg",
      ],
      "descricao": "Escapamento Silencioso para o VolksWagen Gol G5.",
    },
  ];
