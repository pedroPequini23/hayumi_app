...
class Roda4 extends StatelessWidget {
  const Roda4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Jogo de rodas para Chevrolet Onix e Prisma (NOVO)",
      "preco": "R\$ 3500",
      "marca": "Chevrolet",
      "imagens": [
        "img/rodas_onix_prisma.jpg",
        "img/rodas_onix_angulo2.jpg",
        "img/rodas_onix_angulo3.jpg",
      ],
      "descricao": "Jogo de rodas aro 15 da marca Chevrolet, compatíveis com Onix e Prisma",
    },
  ];
