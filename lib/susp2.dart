...
class Susp2 extends StatelessWidget {
  const Susp2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Kit rosca padrão (NOVO)",
      "preco": "R\$ 1300",
      "marca": "Volkswagen",
      "imagens": [
        "img/roscapadrao.jpg",
      ],
      "descricao": "4 amortecedores preparados (ramanufaturado) 4 molas 4 conjuntos de regulagem (roscada / usinagem cnc).",
    },
  ];
