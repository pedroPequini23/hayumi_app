...
class Escape1 extends StatelessWidget {
  const Escape1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Escapamento para Fiat (NOVO)",
      "preco": "R\$ 254",
      "marca": "Fiat",
      "imagens": [
        "img/escape_fiat.jpg",
      ],
      "descricao": "Escapamento original para carros Fiat.",
    },
  ];
