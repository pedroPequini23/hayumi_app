...
class Radiador5 extends StatelessWidget {
  const Radiador5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Radiador de água Fiorino (NOVO)",
      "preco": "R\$ 450",
      "marca": "Notus",
      "imagens": [
        "img/radiador_fiorino_fire.jpg",
        "img/radiador_fiorino_fire2.jpg",
      ],
      "descricao": "Radiador de água para veículos Fiat, como o Fiorino.",
    },
  ];
