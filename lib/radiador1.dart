...
class radiador1 extends StatelessWidget {
  const radiador1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Radiador de agua mahle (NOVO)",
      "preco": "R\$ 500",
      "marca": "Mahle",
      "imagens": [
        "img/radiador_agua_cr.jpg",
      ],
      "descricao": "Radiador de água da marca Mahle",
    },
  ];
