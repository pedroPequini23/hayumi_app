...
class Lamp5 extends StatelessWidget {
  const Lamp5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Lampada H4 100w 90w 12v Rallye Original Bosch (NOVO)",
      "preco": "R\$ 100,00",
      "marca": "Bosch",
      "imagens": [
        "img/lamp5.jpg",
      ],
      "descricao": "Lâmpada Automotiva Bosch 90/100w Halógena 12v. Marca: Bosch Número da peça/Modelo: P43t / H4 - Rallye Tecnologia de lâmpada: Halógena Watts: 90/100W.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Lampada H4 100w 90w 12v Rallye Original Bosch',
            style: TextStyle(
