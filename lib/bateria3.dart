...
class Bateria3 extends StatelessWidget {
  const Bateria3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Bateria de carro Moura 60ah (NOVO)",
      "preco": "R\$ 765",
      "marca": "Moura",
      "imagens": [
        "img/bateria_moura_diferente2.jpg",
      ],
      "descricao": " Bateria versátil para diversos veículos, com capacidade de 60Ah e tensão de 12V, para Vectra, Punto e Camaro.",
    },
  ];
