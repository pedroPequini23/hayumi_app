...
class Retro3 extends StatelessWidget {
  const Retro3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Retrovisor Esquerdo S10 Blazer 1995 A 2011 Elétrico (NOVO)",
      "preco": "R\$ 445",
      "marca": "Chevrolet",
      "imagens": [
        "img/retro_s10.jpg",
      ],
      "descricao": "Retrovisor esquerdo para Chevrolet S10",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Retrovisor Esquerdo S10 Blazer',
            style: TextStyle(
