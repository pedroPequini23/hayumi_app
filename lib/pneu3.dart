...
class Pneu3 extends StatelessWidget {
  const Pneu3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Pneu goodyear aro 16 (NOVO)",
      "preco": "R\$ 1300",
      "marca": "Xbri",
      "imagens": [
        "img/pneu_aro_16_goodyear.jpg",
        "img/pneu_marathon2.jpg",
      ],
      "descricao": "Pneu individual aro 16 goodyear marathon 2.",
    },
  ];
