...
class Filtro5 extends StatelessWidget {
  const Filtro5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Filtro de Ar Spectre (NOVO)",
      "preco": "R\$ 32,50",
      "marca": "Spectre",
      "imagens": [
        "img/filtro5.jpg",
      ],
      "descricao": "Filtro de ar Spectre, oferece boa eficiência em filtragem de partículas.",
    },
  ];
