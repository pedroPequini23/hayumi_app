...
class Freio5 extends StatelessWidget {
  const Freio5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par Disco de Freio ventilado 280,00 mm (NOVO)",
      "preco": "R\$ 800",
      "marca": "Volkswagen",
      "imagens": [
        "img/freio_disco_ventilado_280mm.jpg",
        "img/freio_disco_ventilado2.jpg",
        "img/freio_disco_ventilado3.jpg",
      ],
      "descricao": "Par de Freio a disco ventilado de 280mm para Saveiro ",
    },
  ];
