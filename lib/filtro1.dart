...
class Filtro1 extends StatelessWidget {
  const Filtro1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Filtro de ar simples wix (NOVO)",
      "preco": "R\$ 38,50",
      "marca": "Wix",
      "imagens": [
        "img/filtro1.jpg",
      ],
      "descricao": "Filtro de ar básico para veículos, oferece boa eficiência em filtragem de partículas.",
    },
  ];
