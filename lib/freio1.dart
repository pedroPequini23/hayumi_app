...
class Freio1 extends StatelessWidget {
  const Freio1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par Disco de Freio Dianteiro 328,00 mm",
      "preco": "R\$ 500",
      "marca": "Universal",
      "imagens": [
        "img/freio_dianteiro_328mm.jpg",
        "img/freio_dianteiro_328mm2.jpg",
      ],
      "descricao": "Par de disco de freio de 328mm.",
    },
  ];
