...
class Susp3 extends StatelessWidget {
  const Susp3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Suspensão Fusca Quadro Suspensão Fusca Pivô (NOVO)",
      "preco": "R\$ 1397,94",
      "marca": "Volkswagen",
      "imagens": [
        "img/suspfusca.jpg",
      ],
      "descricao": "01 Suspensão Dianteira completa Fusca Sistema de freio a disco industrializada; 02 Pivôs superiores (Novos); 02 Pivôs inferiores(Novos); 02 Espelhos protetores do disco de freio (Novos).",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Suspensão Fusca Quadro Suspensão Fusca Pivô',
            style: TextStyle(
