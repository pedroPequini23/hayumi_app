...
class Motor41 extends StatelessWidget {
  const Motor41({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Motor da chevrolet 4.1",
      "preco": "R\$ 9000",
      "marca": "Chevrolet",
      "imagens": [
        "img/motor_4_1.jpg",
      ],
      "descricao": "Motor compativel com caravan, opala e blazer",
    },
    // caso fosse necesário add mais produtos
  ];
