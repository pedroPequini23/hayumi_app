...
class Volan2 extends StatelessWidget {
  const Volan2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Volante esportivo Volkswagen (NOVO)",
      "preco": "R\$ 187,99",
      "marca": "Volkswagen",
      "imagens": [
        "img/vw_volan.jpg",
      ],
      "descricao": "Volante esportivo para veículos Volkswagen, com tecnologia avançada e confort.",
    },
  ];
