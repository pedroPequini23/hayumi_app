...
class Filtro3 extends StatelessWidget {
  const Filtro3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Filtro de Ar AEM DryFlow (NOVO)",
      "preco": "R\$ 59,99",
      "marca": "AEM",
      "imagens": [
        "img/filtro3.jpg",
      ],
      "descricao": "Filtro de ar DryFlow da AEM, oferece alta eficiência e durabilidade.",
    },
  ];
