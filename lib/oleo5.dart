...
class Oleo5 extends StatelessWidget {
  const Oleo5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Óleo de Motor Mobil 20w50 1L (NOVO)",
      "preco": "R\$ 29,89",
      "marca": "Mobil",
      "imagens": [
        "img/oleo5.jpg",
      ],
      "descricao": "O Óleo de Motor Mobil 20w50 é um óleo sintético de alta performance, projetado para proteger os motores modernos contra desgaste e corrosão.",
    },
  ];
