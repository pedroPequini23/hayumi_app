...
import 'package:hayumi/lamp1.dart';
import 'package:hayumi/lamp2.dart';
import 'package:hayumi/lamp3.dart';
import 'package:hayumi/lamp4.dart';
import 'package:hayumi/lamp5.dart';
...
class PagLampada extends StatefulWidget {
  const PagLampada({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PagLampadaState createState() => _PagLampadaState();
}

class _PagLampadaState extends State<PagLampada> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Lampadas',style: TextStyle(
      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            ImageButton(
              imagePath: 'img/lamp1.jpg',
              label: 'Lâmpada H4 Phillips',
              labelStyle: const TextStyle(color: Color.fromARGB(255, 0, 36, 84),
              fontWeight: FontWeight.bold),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Lamp1()),
                );
              },
            ),
            ImageButton(
              imagePath: 'img/lamp2.jpg',
              label: 'Lâmpada Osram H4 12v',
              labelStyle: const TextStyle(color: Color.fromARGB(255, 0, 36, 84),
              fontWeight: FontWeight.bold),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Lamp2()),
                );
              },
            ),
            ImageButton(
              imagePath: 'img/lamp3.jpg',
              label: 'Lâmpada Led H4 Haloway 12v',
              labelStyle: const TextStyle(color: Color.fromARGB(255, 0, 36, 84),
              fontWeight: FontWeight.bold),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Lamp3()),
                );
              },
            ),
            ImageButton(
              imagePath: 'img/lamp4outra.jpg',
              label: 'Lâmpada 12v Phillips 55w',
              labelStyle: const TextStyle(color: Color.fromARGB(255, 0, 36, 84),
              fontWeight: FontWeight.bold),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Lamp4()),
                );
              },
            ),
            // Botão com imagem
            ImageButton(
              imagePath: 'img/lamp5.jpg',
              label: 'Lâmpada H4 100w Bosch',
              labelStyle: const TextStyle(color: Color.fromARGB(255, 0, 36, 84),
              fontWeight: FontWeight.bold),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Lamp5()),
                );
              },
            ),
          ],
