...
class Susp1 extends StatelessWidget {
  const Susp1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Suspensão para New Civic (NOVO)",
      "preco": "R\$ 1441,99",
      "marca": "Kayba",
      "imagens": [
        "img/susp_civic.jpg",
      ],
      "descricao": "Jogo de suspensão Kayba para New Civic de 2006 até 2009.",
    },
  ];
