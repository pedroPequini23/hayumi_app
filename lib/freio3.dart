...
class Freio3 extends StatelessWidget {
  const Freio3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par Disco de Freio Dianteiro  280,00 mm (NOVO)",
      "preco": "R\$ 550",
      "marca": "Freemax",
      "imagens": [
        "img/freio_disco_dianteiro280mm.jpg",
        "img/freio_dianteiro_280mm.jpg",
      ],
      "descricao": "Par de freio a disco dianteiro de 280mm da marca freemax ",
    },
  ];
