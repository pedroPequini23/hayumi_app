...
class Motor25 extends StatelessWidget {
  @override
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(16.0),
                    child: Image.asset(
                      'img/motor_parcial_mitsubishi.jpg', // Caminho da imagem do produto --> tem que baixar uma IMG!
                      height: 400.0,
              ...
              Container(
                ...
                child: Text(
                  'Motor compatível com mitsubishi l200',
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.black,
                  ),
