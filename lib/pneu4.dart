...
class Pneu4 extends StatelessWidget {
  const Pneu4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Pneu xbri aro 16 (NOVO)",
      "preco": "R\$ 1150",
      "marca": "Xbri",
      "imagens": [
        "img/pneu_aro_16_xbri.jpg",
        "img/pneu_aro16_xbri2.jpg",
      ],
      "descricao": "Pneu individual aro 16 Xbri Forza A/T 2.",
    },
  ];
