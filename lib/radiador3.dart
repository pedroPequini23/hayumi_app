...
class Radiador3 extends StatelessWidget {
  const Radiador3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Radiador de água Siena (NOVO)",
      "preco": "R\$ 500",
      "marca": "Notus",
      "imagens": [
        "img/radiador_agua_siena.jpg",
        "img/radiador_siena2.jpg",
        "img/radiador_siena3.jpg",
      ],
      "descricao": "Radiador de água para veículos Fiat, como o Siena",
    },
  ];
