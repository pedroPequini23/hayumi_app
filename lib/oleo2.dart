...
class Oleo2 extends StatelessWidget {
  const Oleo2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Óleo de Motor Super SL GT-0IL 1L (NOVO)",
      "preco": "R\$ 16,95",
      "marca": "Super SL",
      "imagens": [
        "img/oleo2.jpg",
      ],
      "descricao": "Óleo de motor convencional para veículos, com boa viscosidade e proteção.",
    },
  ];
