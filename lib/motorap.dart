...
class MotorAp extends StatelessWidget {
  const MotorAp({super.key});
  ...
  final List<Map<String, dynamic>> produtos = [
    {
      ...
      "descricao": "Motor compatível com Gol Quadrado, Gol GTI 1996.",
    },
    // Caso precise adicionar mais produtos, basta incluir novos itens aqui
  ];
