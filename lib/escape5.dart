...
class Escape5 extends StatelessWidget {
  const Escape5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Escapamento silencioso para Doblô (NOVO)",
      "preco": "R\$ 182,35",
      "marca": "Fiat",
      "imagens": [
        "img/escape_doblo.jpg",
      ],
      "descricao": "Escapamento Silencioso para o Fiat Doblô.",
    },
  ];
