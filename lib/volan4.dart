...
class Volan4 extends StatelessWidget {
  const Volan4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Volante Esportivo Renault (NOVO)",
      "preco": "R\$ 140,00",
      "marca": "Renault",
      "imagens": [
        "img/reno_volan.jpg",
      ],
      "descricao": "Volante esportivo para veículos Renault, com design moderno e ergonomia.",
    },
  ];
