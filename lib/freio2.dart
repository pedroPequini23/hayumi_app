...
class Freio2 extends StatelessWidget {
  const Freio2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par Disco de Freio Dianteiro Volvo XC60 328,00 mm (NOVO)",
      "preco": "R\$ 750",
      "marca": "Volvo",
      "imagens": [
        "img/freio_disco_dianteiro_328mm.jpg",
      ],
      "descricao": "Par de Freio a disco dianteiro para o veículo Volvo XC60 ",
    },
  ];
