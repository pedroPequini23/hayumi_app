...
class Roda3 extends StatelessWidget {
  const Roda3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Jogo de rodas para Renault Duster e Oroch (NOVO)",
      "preco": "R\$ 3500",
      "marca": "Renault",
      "imagens": [
        "img/rodas_duster_oroch.jpg",
        "img/rodas_duster_o_angulo2.jpg",
      ],
      "descricao": "Jogo de rodas da marca Renault compatível com Duster e Oroch",
    },
  ];
