...
class Escape2 extends StatelessWidget {
  const Escape2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Escapamento intermediário para Meriva (NOVO)",
      "preco": "R\$ 194",
      "marca": "Chevrolet",
      "imagens": [
        "img/escape_meriva.jpg",
      ],
      "descricao": "Escapamento Intermediário para Chevrolet Meriva.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Escapamento intermediário meriva',
            style: TextStyle(
