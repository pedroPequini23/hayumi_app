...
class Volan5 extends StatelessWidget {
  const Volan5({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Volante Esportivo Chevrolet (NOVO)",
      "preco": "R\$ 159,99",
      "marca": "Chevrolet",
      "imagens": [
        "img/chevy_volan.jpg",
      ],
      "descricao": "Volante esportivo para veículos Chevrolet, com design aerodinâmico e materiais de alta qualidade.",
    },
  ];
