...
class Freio4 extends StatelessWidget {
  const Freio4({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Par Disco de Freio Freemax  287,00 mm (NOVO)",
      "preco": "R\$ 580",
      "marca": "Freemax",
      "imagens": [
        "img/freio_freemax_287mm.jpg",
      ],
      "descricao": "Par de Freio a disco de 287mm da marca freemax ",
    },
  ];
