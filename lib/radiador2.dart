...
class radiador2 extends StatelessWidget {
  const radiador2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Radiador de óleo Supercooler (NOVO)",
      "preco": "R\$ 1400",
      "marca": "Supercooler",
      "imagens": [
        "img/radiador_oleo_alta_performance.jpg",
        "img/radiador_oleo2.jpg",
        "img/radiador_oleo3.jpg",
      ],
      "descricao": "Radiador de óleo Supercooler de alta performance",
    },
  ];
