...
class Volan3 extends StatelessWidget {
  const Volan3({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Volante Racing Sparco R368 em Camurça (NOVO)",
      "preco": "R\$ 2800,00",
      "marca": "Sparco",
      "imagens": [
        "img/sparco_volan.jpg",
      ],
      "descricao": "Volante esportivo da marca Sparco para customizar seu veiculo.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Volante Racing Sparco R368 em Camurça',
            style: TextStyle(
