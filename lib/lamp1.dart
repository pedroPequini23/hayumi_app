...
class Lamp1 extends StatelessWidget {
  const Lamp1({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Lâmpada H4 Phillips (NOVO)",
      "preco": "R\$ 100",
      "marca": "Phillips",
      "imagens": [
        "img/lamp1.jpg",
      ],
      "descricao": "Serve para equipamentos para som, alto falantes, amplificadores, material de instalação, acessórios, alarmes, iluminação, auto elétrica.",
    },
  ];
