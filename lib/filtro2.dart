...
class Filtro2 extends StatelessWidget {
  const Filtro2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Filtro de Ar de Alta Eficiência K&S (NOVO)",
      "preco": "R\$ 20,00",
      "marca": "K&S",
      "imagens": [
        "img/filtro2.jpg",
      ],
      "descricao": "Filtro de ar avançado com tecnologia de filtragem de alta eficiência.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Filtro de Ar de Alta Eficiência K&S',
            style: TextStyle(
