  ...
  final List<Map<String, dynamic>> produtos = [
    {
      ...
      "marca": "Chevrolet",
      "imagens": [
        "img/motorv6camaro.jpg",
      ],
      "descricao": "Motor compatível com Chevrolet Camaro",
    },
    // Caso queira adicionar mais produtos, basta adicionar novos itens aqui
  ];
