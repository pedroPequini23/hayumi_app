...
class Pneu2 extends StatelessWidget {
  const Pneu2({super.key});
...
class _TelaProduto1State extends State<TelaProduto1> {
  final List<Map<String, dynamic>> produtos = [
    {
      "nome": "Pneu xbri aro 15 archiles (NOVO)",
      "preco": "R\$ 1200",
      "marca": "Xbri",
      "imagens": [
        "img/pneu_aro_15_archiles.jpg",
        "img/pneu_aro_15_archiles2.jpg",
      ],
      "descricao": "Pneu individual Xbri aro 15 Archiles.",
    },
  ];
